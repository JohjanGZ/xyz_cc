<script type="text/javascript">
   function Page_lectura_3_3_7_1(){
        start_lectura_3_3_7_1();
        inicio();
        count = 0;
    }
   function Page_20(){
...
// ----------  para iniciar y reiniciar ejercicios sin que afecte el cronometro -----------------------
    function start_lectura_3_3_7_1(){
        $("#ventana").load(ruta+'lectura3-3-7-1/index.php', 
        {
        next: "Page_20()", 
        procesar:"lectura3-3-7-1()",
        titulo:"<center><h5><span>Lee</span> atentamente y responde las preguntas.</h5></center>",
        restaurar:"start_lectura_3_3_7_1()",
        dir:ruta,
        cod: "lectura3-3-7-1",
        nota:cal
        }
