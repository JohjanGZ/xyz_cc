...
function Page_lectura_3_4_8_1() {
    start_lectura_3_4_8_1();
    inicio();
    count = 0;
}
function Page_19() {
...
function start_lectura_3_4_8_1() {
    $("#ventana").load(ruta + 'lectura3-4-8-1/index.php', {
        next: "Page_19()",
        procesar: "lectura3-4-8-1()",
        titulo: "<center><h5><span>Observa</span> la imagen atentamente y completa el cuadro.</h5></center>",
        restaurar: "start_lectura_3_4_8_1()",
        dir: ruta,
        cod: "lectura3-4-8-1",
        nota: cal
    });
