<script type="text/javascript">
   function Page_lectura_3_5_1_1(){
        start_lectura_3_5_1_1();
        inicio();
        count = 0;
    }
   function Page_1(){
   ...
   function  Page_2(){
    ...
    function start_lectura_3_5_1_1(){
        $("#ventana").load(ruta+'lectura3-5-1-1/index.php', 
        {
        next: "Page_1()", 
        procesar:"lectura3-5-1-1()",
        titulo:"<center><h5><span>Lee</span> atentamente y contesta las preguntas.</h5></center>",
        restaurar:"start_lectura_3_5_1_1()",
        dir:ruta,
        cod: "lectura3-5-1-1",
        nota:cal
        }
