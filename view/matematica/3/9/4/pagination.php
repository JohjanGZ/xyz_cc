...
function start_18() {
    $("#ventana").load(ruta + '3-9-18/index.php', {
        next: "Page_19()",
        procesar: "result_tipo_3_9_18()",
...
function start_19() {
    $("#ventana").load(ruta + '3-9-19/index.php', {
        next: "Page_20()",
        procesar: "result_tipo_3_9_19()",
...
function start_20() {
    $("#ventana").load(ruta + '3-9-20/index.php', {
        next: "resultado()",
        procesar: "result_tipo_3_9_20()",
        titulo: "<center><h5><span class='ftitulo'>Observa</span> los lugares que ocupan los siguientes animalitos. Luego <span class='ftitulo'>completa</span> la tabla de posiciones con sus nombres.</h5></center>",
        restaurar: "start_20()",
        dir: ruta,
        cod: "3-9-20",
