...
function start_1() {
    $("#ventana").load(ruta + '3-1-1/index.php', {
        ...
        titulo: "<center><h5><span class='ftitulo'>Ordena</span> correctamente la representación gráfica de los siguientes números: </h5></center>",
        restaurar: "start_1()",
        dir: ruta,
        cod: "3-1-1",
        nota: cal
...
function start_4() {
    $("#ventana").load(ruta + '3-1-4/index.php', {
        ...
        titulo: "<center><h5><span class='ftitulo'>Selecciona</span> el número de las siguientes representaciones gráficas.</h5></center>",
        restaurar: "start_4()",
        dir: ruta,
        cod: "3-1-4",
        nota: cal
