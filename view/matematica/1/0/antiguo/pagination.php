...
function start_1() {
    $("#ventana").load(ruta + '1-0-1/index.php', {
        ...
        titulo: "<center><h5><span class='ftitulo'>Selecciona</span> la maceta que tiene más flores.</h5></center>",
        restaurar: "start_1()",
        dir: ruta,
        cod: "1-0-1",
        nota: cal
...
function start_2() {
    $("#ventana").load(ruta + '1-0-2/index.php', {
        ...
        titulo: "<center><h5>¿Cuántas niñas usarán los vestidos?.</h5></center>",
        restaurar: "start_2()",
        dir: ruta,
        cod: "1-0-2",
        nota: cal
...
function start_3() {
    $("#ventana").load(ruta + '1-0-3/index.php', {
        ...
        titulo: "<center><h5><span class='ftitulo'>Observa</span> los floreros y <span class='ftitulo'>selecciona si</span> o <span class='ftitulo'>no</span>, según corresponda en cada oración.</h5></center>",
        restaurar: "start_3()",
        dir: ruta,
        cod: "1-0-3",
        nota: cal
