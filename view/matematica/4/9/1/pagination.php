...
function start_1() {
    $("#ventana").load(ruta + '2-9-1/index.php', {
        ...
        titulo: "<center><h5><span>Cuenta</span> el material multibase y <span>completa</span> según corresponda.</h5></center>",
        restaurar: "start_1()",
        dir: ruta,
        cod: "2-9-1",
        nota: cal
...
function start_4() {
    $("#ventana").load(ruta + '2-9-4/index.php', {
        ...
        titulo: " <center><h5><span>Observa</span> los recuadros y <span>escribe</span> el número que corresponda.</h5></center>",
        restaurar: "start_4()",
        dir: ruta,
        cod: "2-9-4",
        nota: cal
...
function start_5() {
    $("#ventana").load(ruta + '2-9-5/index.php', {
        ...
        titulo: "<center><h5><span>Ordena</span> los números y <span>colócalos</span> en los casilleros blancos del tren de menor a mayor.</h5></center>",
        restaurar: "start_5()",
        dir: ruta,
        cod: "2-9-5",
        nota: cal
...
function start_6() {
    $("#ventana").load(ruta + '2-9-6/index.php', {
        ...
        titulo: "<center><h5><span>Ordena</span> los vagones del tren de menor a mayor.</h5></center>",
        restaurar: "start_6()",
        dir: ruta,
        cod: "2-9-6",
        nota: cal
