...
function start_23() {
    $("#ventana").load(ruta + '2-1-23/index.php', {
        ...
        titulo: "<center><h5><span>Observa</span> el acertijo y escribe el resultado de la adición.</h5></center>",
        restaurar: "start_23()",
        dir: ruta,
        cod: "2-1-23",
        nota: cal
...
function start_25() {
    $("#ventana").load(ruta + '2-1-25/index.php', {
        ...
        titulo: "<center><h5><span>Observa</span> el acertijo y <span>escribe</span> el resultado de la operación final.</h5></center>",
        restaurar: "start_25()",
        dir: ruta,
        cod: "2-1-25",
        nota: cal
