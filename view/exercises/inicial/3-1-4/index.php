...
<body>
    ...
    <div class="container-two">
        <div class="vertical">
            ...
            <div class="grid-container">
                <div class="grid-item-b" alt="1"><span class="txt">5</span></div>
                <div class="grid-item-b" alt="2"><span class="txt">1</span></div>
                <div class="grid-item-b" alt="3"><span class="txt">4</span></div>
                <div class="grid-item-b" alt="4"><span class="txt">2</span></div>
            </div>
        </div>
    </div>
