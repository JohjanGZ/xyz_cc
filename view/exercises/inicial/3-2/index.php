...
<div class="container">
<ul>
  <li  class="colores" id="blue"><img value="#5a5092" id="a" src="../exercises/inicial/3-2/img/1.png"></li>
  <li  class="colores" id="red"><img value="#5bc3ec" id="e" src="../exercises/inicial/3-2/img/2.png"></li>
  <li  class="colores" id="green"><img value="#85b918" id="i" src="../exercises/inicial/3-2/img/3.png"></li>
  <li  class="colores" id="purple"><img value="#e54d17" id="o" src="../exercises/inicial/3-2/img/4.png"></li>
   <li  class="colores" id="purple"><img value="#ef8306" id="u" src="../exercises/inicial/3-2/img/5.png"></li>
</ul>
      <div class="row svg" >
        <center>    
