        ...
        <div class="row">
            <div class="contenedor-ejercicios">
                ...
                <div class="grid-pregunta">
                    ...
                    <div class="option">
                        <div class="contenedor-img seleccion" alt="">9</div>
                        <div class="contenedor-img seleccion" alt="">7</div>
                        <div class="contenedor-img seleccion" alt="n">8</div>
                    </div>
                </div>
                <div class="grid-pregunta">
                    ...
                    <div class="option">
                        ...
                        <div class="contenedor-img seleccion" alt="n">6</div>
