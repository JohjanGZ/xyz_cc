    ...
    <div class="row svg">
        ...
        <div class="campo" id="imgIzquierda">
            ...
            <ul id="listA">
                ...
                <li alt="3" class="a" id="obj2"><img src="<?= $dir ?>/img/3.png"></li>
                <li alt="5" class="a" id="obj3"><img src="<?= $dir ?>/img/5.png"></li>
                <li alt="7" class="a" id="obj4"><img src="<?= $dir ?>/img/7.png"></li>
                <li alt="9" class="a" id="obj5"><img src="<?= $dir ?>/img/9.png"></li>
            </ul>
        ...
        <div class="campo" id="imgDerecha">
            <ul id="listB">
                <li alt="1" class="b" id="obj2"><img src="<?= $dir ?>/img/2.png" alt="">
                </li>
                <li alt="3" class="b" id="obj3"><img src="<?= $dir ?>/img/4.png" alt="">
                </li>
                <li alt="5" class="b" id="obj4"><img src="<?= $dir ?>/img/6.png" alt="">
                </li>
                <li alt="7" class="b" id="obj4"><img src="<?= $dir ?>/img/8.png" alt="">
                </li>
                <li alt="9" class="b" id="obj4"><img src="<?= $dir ?>/img/10.png" alt="">
                </li>
            </ul>
        </div>
