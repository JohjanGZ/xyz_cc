  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="dos" class="a" id="obj1"><span>Blanquita por dentro, verde por fuera. ¿Sabes quién soy? Solo espera.</span></li>
                    <li alt="tres" class="a" id="obj2"><span>Soy verde por fuera, a veces rayada. Rojita por dentro y con mis pepitas contento.</span></li>
                    <li alt="uno" class="a" id="obj2"><span>Lleva un abrigo amarillo y largo. Si quieres comerlo, tendrás que quitárselo.</span></li>
                </ul>

            </div>
            <div class="campo" id="centro">
                <canvas height="100px" width="900px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><img src="<?= $dir ?>/img/1.png" alt=""></li>
                  <li alt="dos" class="b" id="obj7"><img src="<?= $dir ?>/img/2.png" alt=""></li>
                  <li alt="tres" class="b" id="obj8"><img src="<?= $dir ?>/img/3.png" alt=""></li>
                </ul>
            </div>
