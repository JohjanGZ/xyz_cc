<?php require('../../../tools/var/variables.php'); ?>
          ...
          <link rel="stylesheet" type="text/css" href="../../../exercises/inicial/3-1-3/css/styles.css">
          </head>
  <?=$titulo?>
<div class="container">
      <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
              ...
              <ul id="listA">
                <li alt="p"  class="a" id="obj1"><img src="../../../exercises/inicial/3-1-3/img/1.png"></li>
                <li alt="m" class="a" id="obj2"><img src="../../../exercises/inicial/3-1-3/img/2.png"></li>
                <li alt="c" class="a" id="obj3"><img src="../../../exercises/inicial/3-1-3/img/3.png"></li>
                <li alt="f" class="a" id="obj4"><img src="../../../exercises/inicial/3-1-3/img/4.png"></li>
              </ul>
          
            </div>
            <div class="campo" id="centro">
              <canvas height="400px" width="300px" id="micanvas"></canvas> 
              </div>
            <div class="campo" id="imgDerecha">
              <ul id="listB">
                <li alt="m" class="b" id="obj1"><img src="../../../exercises/inicial/3-1-3/img/5.png"></li>
                <li alt="p" class="b" id="obj2"><img src="../../../exercises/inicial/3-1-3/img/6.png"></li>
                <li alt="c" class="b" id="obj3"><img src="../../../exercises/inicial/3-1-3/img/7.png"></li>
                <li alt="f" class="b" id="obj4"><img src="../../../exercises/inicial/3-1-3/img/8.png"></li>
              </ul>
            </div>
          ...
          <div class="row fila2">
              ...
              <div id="modal1" class="modal">
                  ...
                  <center>
                  <img class="materialboxed"  width="80%" src="../../../inicial/3-1-3/img/respuesta.png">
                  </center>
                  </div>
