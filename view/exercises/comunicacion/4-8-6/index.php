  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>decir una historia</span></li>
                    <li alt="dos" class="a" id="obj2"><span>decir un secreto</span></li>
                    <li alt="tres" class="a" id="obj3"><span>decir una mentira</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>decir un poema</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>narrar</span></li>
                  <li alt="dos" class="b" id="obj7"><span>revelar</span></li>
                  <li alt="tres" class="b" id="obj8"><span>inventar</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>recitar</span></li>
                </ul>
            </div>
