  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Imperativa</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Desiderativa</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Dubitativa</span></li> 
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>¡Cierra la puerta!</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Quisiera ir de paseo el sábado.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Ojalá regrese pronto.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>¡Qué alegría siento hoy!</span></li>
                </ul>
            </div>
