    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="contenedor-silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="insectos">Arácnidos</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="hormiga">Araña</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="aracnidox">Hormiga</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="aracnidos">Insectos</h4>
                </li>
            </ul>
        </div>
    </div>
