    ...
    <div class="container-two">
        <div class="vertical">
            ...
            <div class="grid-container">
                ...
                <div class="grid-item-b" alt="5"><img src="<?=$dir?>/img/8.png" class="img"></div>
                <div class="grid-item-b" alt="2"><img src="<?=$dir?>/img/9.png" class="img"></div>
                <div class="grid-item-b" alt="1"><img src="<?=$dir?>/img/10.png" class="img"></div>
            </div>
        </div>
    </div>
    <!-- Respuesta -->
