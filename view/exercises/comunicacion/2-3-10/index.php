  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="centro">
                <canvas height="100px" width="840px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>caja</span></li>
                  <li alt="cuatro" class="b" id="obj7"><span>caminos</span></li>
                  <li alt="dos" class="b" id="obj8"><span>calles</span></li>
                  <li alt="tres" class="b" id="obj7"><span>teléfono</span></li>
                </ul>
            </div>
