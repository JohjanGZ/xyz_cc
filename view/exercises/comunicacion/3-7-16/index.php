  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Enunciativa negativa</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Interrogativa</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Enunciativa afirmativa</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Exclamativa</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>No podré asistir a la fiesta</span></li>
                  <li alt="dos" class="b" id="obj7"><span>¿Cuánto tiempo debemos esperar?</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Me gusta hacer deporte todos los días</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>¡Qué bueno verte!</span></li>
                </ul>
            </div>
