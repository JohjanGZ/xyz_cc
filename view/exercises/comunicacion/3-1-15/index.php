  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Esdrújula</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Agudas</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Graves</span></li> 
                </ul>

            </div>
            <div class="campo" id="centro">
                <canvas height="100px" width="750px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Tienen la mayor fuerza de voz en la antepenúltima sílaba.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Tienen la mayor fuerza de voz en la última sílaba.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Tienen la sílaba tónica en la penúltima sílaba.</span></li>
                </ul>
            </div>
