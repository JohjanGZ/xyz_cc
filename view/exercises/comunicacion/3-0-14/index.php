    ...
    <div class="container">
        <div class="row">
            ...
            <div class="contenedor-oraciones">
                ...
                <div class="oracion">
                    <h5>
                        <span>•</span> ¿Quiénes son los personajes del cuento?
                    </h5>
                    <div class="contenedor-check">
                        <div class="respuesta" alt="n">
                            <span>Las ranitas y el tronco.</span>
                        </div>
                        <div class="respuesta">
                            <span>El astrónomo.</span>
                        </div>
                        <div class="respuesta">
                            <span>Caperucita y el lobo.</span>
                        </div>
                        <div class="respuesta">
                            <span>Palitroque y su abuela.</span>
                        </div>
                    </div>
                ...
                <div class="oracion">
                    ...
                    <div class="contenedor-check">
                        <div class="respuesta" alt="n">
                            <span>En un lago.</span>
                        </div>
                        <div class="respuesta">
                            <span>En el desierto.</span>
                        </div>
                        <div class="respuesta">
