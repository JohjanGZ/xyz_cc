  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Martillo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Tornillo</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Lija</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Fuerte</span></li>
                  <li alt="dos" class="b" id="obj7"><span>une y <br> da fuerza</span></li>
                  <li alt="tres" class="b" id="obj8"><span>afina y <br> lima asperezas</span></li>
                </ul>
            </div>
