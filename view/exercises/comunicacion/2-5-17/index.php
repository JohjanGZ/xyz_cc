  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Pedir peras al olmo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Tener malas pulgas</span></li>
                    <li alt="tres" class="a" id="obj3"><span>A pedir de boca</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Pedir cosas imposibles.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Tener mal carácter.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Demasiado bien, perfecto.</span></li>
                </ul>
            </div>
