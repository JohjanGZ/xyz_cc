<?php require('../../../tools/var/variables.php'); ?>
  ...
  <body>
    ...
    <div class="container-two">
        ...
        <!-- <div id='Palabras'></div> -->
        <div class="preguntas">
            <p><span>1.</span>Combate.</p>
            <p><span>2.</span>Embajada.</p>
            <p><span>3.</span>Recibir.</p>
            <p><span>4.</span>Amaba.</p>
            <p><span>5.</span>Suave.</p>
            <p><span>6.</span>Positivo</p>
            <p><span>7.</span>Grave</p>
            <p><span>8.</span>Amabilidad</p>
            <p><span>9.</span>Posibilidad</p>
            <p><span>10.</span>Adviento</p>
        </div>
    </div>
    <!-- Respuesta -->
...
<script type="text/javascript">
    var words = ['combate', 'embajada', 'recibir', 'amaba', 'suave','positivo','grave','amabilidad','posibilidad','adviento'];
