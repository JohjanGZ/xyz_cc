<?php require('../../../tools/var/variables.php'); ?>
  ...
  <body>
    ...
    <div class="container-two">
        ...
        <!-- <div id='Palabras'></div> -->
        <div class="preguntas">
            <p><span>1.</span>Tragedia</p>
            <p><span>2.</span>Moliére</p>
            <p><span>3.</span>Drama</p>
            <p><span>4.</span>Destino.</p>
            <p><span>5.</span>Shakespeare.</p>
            <p><span>6.</span>Comedia</p>
        </div>
    </div>
    <!-- Respuesta -->
...
<script type="text/javascript">
    var words = ['Tragedia', 'Moliére', 'Drama', 'Destino', 'Shakespeare', 'Comedia'];
