  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Alejandra y yo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Mi mamá</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Los niños</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>cantamos una bella canción.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>me regaló una chompita.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>jugaron en el parque.</span></li>
                </ul>
            </div>
