  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Hablo por teléfono con mi abuelo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Saludo con la mano a mis amigos</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Me paro ante un semáforo rojo</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Llamé un taxi con un sílbido</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Lenguaje</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Gestos</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Imágenes</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Sonidos</span></li>
                </ul>
            </div>
