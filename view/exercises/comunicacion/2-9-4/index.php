  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>oso</span></li>
                    <li alt="dos" class="a" id="obj2"><span>lechuza</span></li>
                    <li alt="tres" class="a" id="obj3"><span>abejas</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>ocioso</span></li>
                  <li alt="dos" class="b" id="obj7"><span>inteligente</span></li>
                  <li alt="tres" class="b" id="obj8"><span>trabajadoras</span></li>
                </ul>
            </div>
