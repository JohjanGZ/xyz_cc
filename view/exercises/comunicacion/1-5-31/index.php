  ...
  <div class="container">
        <div class="row">
           ...
           <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="uno">alto</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="dos">bajo</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="tres">triste</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">anciana</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">sucio</h4>
                </li>
                <li class="silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="">feliz</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">limpio</h4>
                </li>
            </ul>
        </div>
    </div>
