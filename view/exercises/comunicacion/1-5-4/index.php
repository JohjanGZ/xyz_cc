  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><img src="<?= $dir ?>/img/1.png"></li>
                  <li alt="dos" class="b" id="obj7"><img src="<?= $dir ?>/img/2.png"></li>
                  <li alt="tres" class="b" id="obj8"><img src="<?= $dir ?>/img/3.png"></li>
                </ul>
            </div>
