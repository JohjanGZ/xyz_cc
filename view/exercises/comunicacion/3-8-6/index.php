  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>La casa amarilla</span></li>
                    <li alt="dos" class="a" id="obj2"><span>El vaso de cristal</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Miguel y Daniel</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>El árbol de manzana</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>tiene ventanas grandes.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>está lleno de agua.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>juegan un partido de fútbol.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>tiene muchos frutos.</span></li>
                </ul>
            </div>
