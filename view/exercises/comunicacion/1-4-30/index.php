  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="gelatina" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="manguera" class="a" id="obj2"><img src="<?= $dir ?>/img/3.png"></li>
                    <li alt="angel" class="a" id="obj3"><img src="<?= $dir ?>/img/5.png"></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="angel" class="b" id="obj6"><img src="<?= $dir ?>/img/2.png"></li>
                  <li alt="gelatina" class="b" id="obj7"><img src="<?= $dir ?>/img/4.png"></li>
                  <li alt="manguera" class="b" id="obj8"><img src="<?= $dir ?>/img/6.png"></li>
                </ul>
            </div>
