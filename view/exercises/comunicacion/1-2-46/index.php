        ...
        <div class="contenedor-ejercicio"> 
            ...
            <div class="contenedor-ejemplo contenedor-oraciones">
                   <div class="contenedor-oracion">
                       ...
                       <span class="span-after">es de Malena.</span>
                   </div>
                   <div class="contenedor-palabras">
                       <div class="contenedor-faltante" alt="mona">
                           
                       </div>
                       <div class="contenedor-faltante" alt="chita">
            ...
            <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="mona">mona</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="chita">Chita</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">león</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">Alex</h4>
                </li>
            </ul>
        </div>
