  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="rojo" class="a" id="obj1"><span>rojo</span></li>
                    <li alt="aguja" class="a" id="obj2"><span>aguja</span></li>
                    <li alt="caja" class="a" id="obj3"><span>caja</span></li> 
                    <li alt="juego" class="a" id="obj2"><span>juego</span></li>
                    <li alt="reloj" class="a" id="obj3"><span>reloj</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="aguja" class="b" id="obj6"><span>aguijón</span></li>
                  <li alt="reloj" class="b" id="obj7"><span>relojero</span></li>
                  <li alt="juego" class="b" id="obj8"><span>juguete</span></li>
                  <li alt="rojo" class="b" id="obj7"><span>anaranjado</span></li>
                  <li alt="caja" class="b" id="obj8"><span>cajón</span></li>
                </ul>
            </div>
