  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Los pájaros construyen sus casas en las copas.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Un equipo inglés levantó la copa de campeones.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Un día llegaré al pico de esa montaña.</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>El albañil coge un pico.</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><img src="<?= $dir ?>/img/3.png" alt=""></li>
                  <li alt="dos" class="b" id="obj7"><img src="<?= $dir ?>/img/2.png" alt=""></li>
                  <li alt="tres" class="b" id="obj8"><img src="<?= $dir ?>/img/1.png" alt=""></li>
                  <li alt="cuatro" class="b" id="obj8"><img src="<?= $dir ?>/img/4.png" alt=""></li>
                </ul>
            </div>
