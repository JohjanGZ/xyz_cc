  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="sombrero" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="sobre" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                    <li alt="cabra" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png"></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="cabra" class="b" id="obj6"><span>cabra</span></li>
                  <li alt="sombrero" class="b" id="obj7"><span>sombrero</span></li>
                  <li alt="sobre" class="b" id="obj8"><span>sobre</span></li>
                </ul>
            </div>
