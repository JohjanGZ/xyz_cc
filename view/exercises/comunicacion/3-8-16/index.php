        ...
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    ...
                    <li alt="tres" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png" alt=""></li> 
                    <li alt="cuatro" class="a" id="obj3"><img src="<?= $dir ?>/img/4.png" alt=""></li> 
                    <li alt="cuatro" class="a" id="obj3"><img src="<?= $dir ?>/img/5.png" alt=""></li> 
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Convencional</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Miedo</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Grito</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Pánico</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Pensamiento</span></li>
