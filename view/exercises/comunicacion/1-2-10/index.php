  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="paleta" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="pato" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                    <li alt="tomate" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png"></li>
                    <li alt="lata" class="a" id="obj4"><img src="<?= $dir ?>/img/4.png"></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                ...
                <li alt="paleta" class="b" id="obj6"><center><span>Paleta</span></center></li>
                <li alt="pato" class="b" id="obj7"><center><span>Pato</span></center></li>
                <li alt="tomate" class="b" id="obj8"><center><span>Tomate</span></center></li>
                <li alt="lata" class="b" id="obj9"><center><span>Lata</span></center></li>  
                </ul>
            </div>
