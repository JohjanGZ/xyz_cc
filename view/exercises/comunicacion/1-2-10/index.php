...
<div class="container">  
  	<section id="contenedorpuzzle">
          <div class="row">
          	<div class="campo"><div class="item" alt="" id="item1"><img src="<?= $dir ?>/img/1.png">
            </div><div class="ta"><span alt="n">ta</span><span>ta</span></div></div>
          	<div class="campo"><div class="item"  id="item2"><img alt="n" src="<?= $dir ?>/img/2.png">      
            </div><div class="ta"><span>ta</span><span alt="n">ta</span></div>
            </div>
          	<div class="campo"><center><div class="item" id="item3"><img src="<?= $dir ?>/img/3.png">       
            </div><div class="ta"><span>ta</span><span alt="n">ta</span><span>ta</span></div></center>
            </div>
            <div class="campo"><div class="item"  id="item4"><img src="<?= $dir ?>/img/4.png">
            </div><div class="ta"><span>ta</span><span>ta</span><span alt="n">ta</span></div>
            </div>
            <div class="campo"><div class="item" id="item5"><img src="<?= $dir ?>/img/5.png">
            </div><div class="ta"><span>ta</span><span alt="n">ta</span><span>ta</span></div></div>
            <div class="campo"><div class="item"  id="item6"><img  src="<?= $dir ?>/img/6.png">       
