  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="globo" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="cuchara" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                    <li alt="martillo" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png"></li>
                    <li alt="tenedor" class="a" id="obj4"><img src="<?= $dir ?>/img/4.png"></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                ...
                <li alt="globo" class="b" id="obj6"><img src="<?= $dir ?>/img/8.png"></li>
                <li alt="cuchara" class="b" id="obj7"><img src="<?= $dir ?>/img/6.png"></li>
                <li alt="martillo" class="b" id="obj8"><img src="<?= $dir ?>/img/7.png"></li>
                <li alt="tenedor" class="b" id="obj9"><img src="<?= $dir ?>/img/5.png"></li>  
                </ul>
            </div>
