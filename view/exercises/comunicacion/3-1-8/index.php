  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Ignorante</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Hambriento</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Encontrar</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Extraño</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>sabio</span></li>
                  <li alt="dos" class="b" id="obj7"><span>satisfecho</span></li>
                  <li alt="tres" class="b" id="obj8"><span>perder</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>conocido</span></li>
                </ul>
            </div>
