  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Unir</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Reparar</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Dar</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Duro</span></li> 
                    <li alt="cinco" class="a" id="obj3"><span>Limpiar</span></li> 
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Separar</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Malograr</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Recibir</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Blando</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>Ensuciar</span></li>
