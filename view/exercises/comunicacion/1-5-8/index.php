  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="viejo" class="a" id="obj1"><span>viejo</span></li>
                    <li alt="jardin" class="a" id="obj2"><span>jardín</span></li>
                    <li alt="jarron" class="a" id="obj3"><span>jarrón</span></li> 
                    <li alt="pasajero" class="a" id="obj2"><span>pasajero</span></li>
                    <li alt="masaje" class="a" id="obj3"><span>masaje</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="jardin" class="b" id="obj6"><span>hojas</span></li>
                  <li alt="pasajero" class="b" id="obj7"><span>viaje</span></li>
                  <li alt="viejo" class="b" id="obj8"><span>joven</span></li>
                  <li alt="jarron" class="b" id="obj7"><span>jarra</span></li>
                  <li alt="masaje" class="b" id="obj8"><span>masajista</span></li>
                </ul>
            </div>
