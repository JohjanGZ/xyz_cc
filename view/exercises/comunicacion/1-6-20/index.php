           ...
           <div class="contenedor-ejercicios">
                <div class="ejercicio">
                    <div class="contenedor-respuesta">
                        ...
                        <span>El sol está en una</span>
                        <div class="palabra" alt="galaxia"></div>
                    </div>
                </div>
                <div class="ejercicio">
                    <div class="contenedor-respuesta">
                        <img src="<?= $dir ?>/img/2.png">
                        <span>Mandame el documento por</span>
                        <div class="palabra" alt="fax"></div>
                    </div>
                </div>
                <div class="ejercicio">
                    <div class="contenedor-respuesta">
                        <img src="<?= $dir ?>/img/3.png">
                        <span>Este guiso esta</span>
                        <div class="palabra" alt="exquisito"></div>
                    </div>
                </div>
           </div>
