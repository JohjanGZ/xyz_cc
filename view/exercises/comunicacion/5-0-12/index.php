  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Emisor</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Receptor</span></li>
                    <li alt="tres" class="a" id="obj2"><span>Mensaje</span></li>
                    <li alt="cuatro" class="a" id="obj2"><span>Canal</span></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>El que envía el mensaje</span></li>
                  <li alt="dos" class="b" id="obj7"><span>El que recibe el mensaje</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>El medio por donde se envía el mensaje</span></li>
                  <li alt="tres" class="b" id="obj9"><span>Lo que se quiere transmitir</span></li>
                </ul>
            </div>
