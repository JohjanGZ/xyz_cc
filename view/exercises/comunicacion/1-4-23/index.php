        ...
        <div class="row center">
            ...
            <div class="row" id="recibidor">
                <div class="contenedor-elementos">
                    ...
                    <div class="contenedor-element">
                        <div class="imagen-nube">
                            <img src="<?= $dir ?>/img/3-3.png" class="img-responsive">
                        </div>
                        <div class="contenedor-silaba">
                            <div class="contenedor-faltante" id="3"></div>
                        </div>
                        <div class="imagen">
                            <img src="<?= $dir ?>/img/3.png" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
            <div class="contenedor-silabas">
                <div class="silabas">
                    <h4 class="pieza" alt="1">humo</h4>
                </div>
                <div class="silabas">
                    <h4 class="pieza" alt="2">hongo</h4>
                </div>
                <div class="silabas">
                    <h4 class="pieza" alt="3">huellas</h4>
                </div>
                <div class="silabas">
                    <h4 class="pieza" alt="4">hebilla</h4>
                </div>
                <div class="silabas">
                    <h4 class="pieza" alt="5">hielo</h4>
                </div>
            </div>
        </div>
