  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>hora - día</span></li>
                    <li alt="dos" class="a" id="obj2"><span>estrella - <br> constelación</span></li>
                    <li alt="tres" class="a" id="obj3"><span>ají - picante</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>parte - todo</span></li>
                  <li alt="dos" class="b" id="obj7"><span>elemento - conjunto</span></li>
                  <li alt="tres" class="b" id="obj8"><span>agente - característica</span></li>
                </ul>
            </div>
