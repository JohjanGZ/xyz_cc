  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Largo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Rápido</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Separar</span></li> 
                    <li alt="cuatro" class="a" id="obj2"><span>Dar</span></li>
                    <li alt="cinco" class="a" id="obj3"><span>Blando</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Corto</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Lento</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Unir</span></li>
                  <li alt="cuatro" class="b" id="obj7"><span>Recibir</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>Duro</span></li>
                </ul>
            </div>
