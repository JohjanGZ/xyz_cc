  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Hilandera</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Tejedor</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Sastre</span></li> 
                </ul>

            </div>
            <div class="campo" id="centro">
                <canvas height="100px" width="828px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>A la vuelta y vuelta.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Tris, tres, tras.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Medir, medir y medir.</span></li>
                </ul>
            </div>
