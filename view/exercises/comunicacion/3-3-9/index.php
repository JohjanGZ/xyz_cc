  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>punto y seguido</span></li>
                    <li alt="dos" class="a" id="obj2"><span>punto y aparte</span></li>
                    <li alt="tres" class="a" id="obj3"><span>punto final</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Es el que separa las oraciones que forman un párrafo.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Se usa para separar 2 párrafos que suelen tratar ideas diferentes de un mismo tema.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Es usado para dividir partes importantes de un texto, como el capítulo de un libro.</span></li>
                </ul>
            </div>
