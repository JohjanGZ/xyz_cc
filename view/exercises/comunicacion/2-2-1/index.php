  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Respingo</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Agitación</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Alarmado</span></li> 
                    <li alt="cuatro" class="a" id="obj2"><span>Despegue</span></li>
                    <li alt="cinco" class="a" id="obj3"><span>Impecable</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="cuatro" class="b" id="obj6"><span>separarse del suelo al iniciar el vuelo</span></li>
                  <li alt="tres" class="b" id="obj7"><span>asustado, inquieto</span></li>
                  <li alt="uno" class="b" id="obj8"><span>sorpresa, sobresalto</span></li>
                  <li alt="cinco" class="b" id="obj7"><span>perfecto, exacto</span></li>
                  <li alt="dos" class="b" id="obj8"><span>inquietud, temor</span></li>
                </ul>
            </div>
