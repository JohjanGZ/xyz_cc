        ...
        <div class="svg">
            <div class="campo" id="Izquierda">
                <ul id="listA">
                    ...
                    <li class="a" alt="x" id="obj3"><span>ca</span></li>
                    <li class="a" alt="x" id="obj4"><span>ca</span></li>
                </ul>
            ...
            <div class="campo" id="Centro">
                <ul id="listB">
                    ...
                    <li class="b" alt="x" id="obj3"><span>si</span></li>
                    <li class="b" alt="x" id="obj4"><span>mi</span></li>
                </ul>
            </div> 
            ...
            <div class="campo" id="Derecha">
                <ul id="listC">
                    ...
                    <li class="c" alt="x" id="obj3"><span>llo</span></li>
                    <li class="c" alt="x" id="obj4"><span>no</span></li>
                </ul>
            </div> 
        </div>
    </div>
