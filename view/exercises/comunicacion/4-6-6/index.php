  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>No iré si llueve.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Le dije que sí voy.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Por honrada te voy a comprar algo.</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Voy a tomar una taza de té.</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Si (condicional)</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Sí (afirmación)</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Te (pronombre personal)</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Té (infusión)</span></li>
                </ul>
            </div>
