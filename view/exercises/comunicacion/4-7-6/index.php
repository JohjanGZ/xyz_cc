  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Si queremos hacer muchas cosas a la vez, lograremos poco.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Una persona a hecho algo importante, de valor incalculable.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Aveces no nos decidimos por una cosa ni por la otra.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>No haber dormido toda la noche por alguna razón</span></li>
                </ul>
            </div>
