  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>La casa blanca</span></li>
                    <li alt="dos" class="a" id="obj2"><span>El bello gatito</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Juan y yo</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Ana y Jimena</span></li> 
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>tiene cinco pisos.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>duerme toda la tarde.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>comemos un rico helado.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>jugaron voley.</span></li>
                </ul>
            </div>
