<?php require('../../../tools/var/variables.php'); ?>
          ...
          <link rel="stylesheet" type="text/css" href="../../../exercises/comunicacion/1-1-10/css/styles.css">
          </head>
          <style type="text/css">
h4 {
    text-align: center;
    ...
    <div class="container">
        <div class="row">
            <div class="campo" id="palabras">
                <ul id="listA">
                    <li>
                        <img src="../../../exercises/comunicacion/1-1-10/img/2.png" class="responsive-img">
                    ...
                    <li>
                        <img src="../../../exercises/comunicacion/1-1-10/img/4.png" class="responsive-img">
                        <span class="a" alt="n">u</span>
                        <span class="a" alt="">v</span>
                        <span class="a" alt="">a</span>
                    </li>
                    <li>
                        <img src="../../../exercises/comunicacion/1-1-10/img/3.png" class="responsive-img">
                        <span class="a" alt="n">u</span>
                        <span class="a" alt="">ñ</span>
                        <span class="a" alt="">a</span>
                    </li>
                    <li>
                        <img src="../../../exercises/comunicacion/1-1-10/img/1.png" class="responsive-img">
