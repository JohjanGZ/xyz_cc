  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Cantidad de carne baja en grasa</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Cantidad de arroz, pastas cocinadas o cereal</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Cantidad de mantequilla de maní</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Cantidad de queso</span></li>
                </ul>
            </div>
