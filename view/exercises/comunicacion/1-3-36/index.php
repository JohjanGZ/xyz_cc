        ...
        <div class="center">
            <div id="contenedorPiezas">
                <ul id="listA">
                    ...
                    <li>
                        <div class="box">
                            <img class="pieza responsive-img" id="v4" src="<?= $dir ?>/img/4.png" alt="pieza4">
                        </div>
                    </li>
                </ul>
            </div>
            <div class="row recibidor" id="recibidor">
                <div class="caja-flex">
                    <div class="contenedorPieza" id="r">
                        <label class="title">Con r</label>
                    </div>
                    <div class="contenedorPieza" id="rr">
                        <label class="title">Con rr</label>
                    </div>
                </div>
            </div>
        </div>
