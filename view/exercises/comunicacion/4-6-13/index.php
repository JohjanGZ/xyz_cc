  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>El aire acondicionado no funcionaba.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Margot lloró toda la tarde.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>José Luis llegó muy tarde a casa.</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Caminé toda la tarde bajo la lluvia.</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Por ello hacía mucho calor.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Su adorada mascota se perdió por varios días.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Su mamá estaba muy preocupada.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Por eso ahora tengo un fuerte resfriado.</span></li>
                </ul>
            </div>
