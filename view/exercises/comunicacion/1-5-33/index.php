  ...
  <div class="container">
        <div class="row">
           ...
           <ul class="contenedor-silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="dos">día</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">dormido</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">joven</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="uno">noche</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="tres">despierto</h4>
                </li>
            </ul>
        </div>
    </div>
