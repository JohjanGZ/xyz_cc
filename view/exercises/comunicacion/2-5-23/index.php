  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Sentir</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Avisó</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Atrapó</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Arrugadas</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Quipi pudo <span>percibir</span> el olor del cocodrilo</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Quipi <span>alertó</span> con gritos a sus amigos</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Quipi <span>alcanzó</span> la rama de un árbol.</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Quipi recordó las palabras de sus <span>rugosas</span> tías.</span></li>
                </ul>
            </div>
