  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Esas imágenes me dejaron mudo,</span></li>
                    <li alt="dos" class="a" id="obj2"><span>La ecología se apoya en otras ciencias,</span></li>
                    <li alt="tres" class="a" id="obj2"><span>Debemos organizarnos</span></li>
                    <li alt="cuatro" class="a" id="obj2"><span>Habíamos realizado una colecta</span></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>en otras palabra, me impactaron.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>es decir, es una ciencia multidisciplinaria.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>a fin de evitar accidentes durante sismos.</span></li>
                  <li alt="cuatro" class="b" id="obj9"><span>con la finalidad de celebrar la Navidad.</span></li>
                </ul>
            </div>
