  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Primero</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Luego</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Al final</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Se hierve en agua 5 azucenas, 2 margaritas y 20 pétalos de rosa.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Se añade 5 gotas de miel.</li>
                  <li alt="tres" class="b" id="obj8"><span>Se deja enfriar y se sirve</span></li>
                </ul>
            </div>
