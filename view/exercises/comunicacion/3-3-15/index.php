  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>La casa de Rosa y Jesús</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Los juguetes míos</span></li>
                    <li alt="tres" class="a" id="obj3"><span>El colegio de esos niños</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Su casa</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Mis juguetes</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Su colegio</span></li>
                </ul>
            </div>
