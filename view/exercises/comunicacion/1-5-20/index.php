  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="llama" class="a" id="obj1"><span>llama</span></li>
                    <li alt="llorar" class="a" id="obj2"><span>llorar</span></li>
                    <li alt="ballena" class="a" id="obj3"><span>ballena</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="llama" class="b" id="obj6"><img src="<?= $dir ?>/img/2.png"></li>
                  <li alt="llorar" class="b" id="obj7"><img src="<?= $dir ?>/img/3.png"></li>
                  <li alt="ballena" class="b" id="obj8"><img src="<?= $dir ?>/img/1.png"></li>
                </ul>
            </div>
