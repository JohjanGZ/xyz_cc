        ...
        <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                    ...
                    <li alt="i" class="b" id="obj2"><img src="<?= $dir ?>/img/6.png"></li>
                    <li alt="u" class="b" id="obj3"><img src="<?= $dir ?>/img/7.png"></li>
                    <li alt="e" class="b" id="obj4"><img src="<?= $dir ?>/img/8.png"></li>
                    <li alt="a" class="b" id="obj4"><img src="<?= $dir ?>/img/9.png"></li>
