  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Elena se marea en el yate.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Yo desayuno mi bollo.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>La yema es amarilla.</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><img src="<?= $dir ?>/img/3.png"></li>
                  <li alt="dos" class="b" id="obj7"><img src="<?= $dir ?>/img/1.png"></li>
                  <li alt="tres" class="b" id="obj8"><img src="<?= $dir ?>/img/2.png"></li>
                </ul>
            </div>
