  ...
  <div class="container">
        <div class="row">
           ...
           <ul class="contenedor-silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="tres">anciana</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="dos">joven</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="uno">dormido</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">noche</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">día</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">despierto</h4>
                </li>
            </ul>
        </div>
    </div>
