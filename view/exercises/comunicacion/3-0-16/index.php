    ...
    <div class="container">
        <div class="row">
            ...
            <div class="contenedor-ejercicios">
                <div class="ejercicio">
                    ...
                    <div class="contenedor-respuesta">
                        <div class="palabra" alt="televisor">
                ...
                <div class="ejercicio">
                    ...
                    <div class="contenedor-respuesta">
                        <div class="palabra" alt="periodico">
            ...
            <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="televisor">televisor</h4>
                </li>
                <li class="silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="radio">radio</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="periodico">periodico</h4>
                </li>
            </ul>
        </div>
    </div>
