    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="cojin">cojín</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="gorro">gorro</h4>
                </li>
                <li class="silabas">
                ...
                <li class="silabas">
                    <h4 class="pieza" alt="jugo">jugo</h4>
                </li>
            </ul>
        </div>
    </div>
