    ...
    <div class="container-two">
        <div class="vertical">
            ...
            <div class="grid-canva">
                <canvas id="micanvas" width="95" height="583"></canvas>
            </div>
            <div class="grid-container">
                <div class="grid-item-b" alt="4"><img src="<?=$dir?>/img/11.png" class="img"></div>
                <div class="grid-item-b" alt="6"><img src="<?=$dir?>/img/22.png" class="img"></div>
                ...
                <div class="grid-item-b" alt="5"><img src="<?=$dir?>/img/66.png" class="img"></div>
            </div>
        </div>
    </div>
