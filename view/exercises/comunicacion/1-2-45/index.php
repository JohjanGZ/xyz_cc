        ...
        <div class="contenedor-ejercicio"> 
            ...
            <div class="contenedor-ejemplo contenedor-oraciones">
                   <div class="contenedor-oracion">
                       ...
                       <span class="span-after">es esposo de mi tía.</span>
                   </div>
                   <div class="contenedor-palabras">
                       <div class="contenedor-faltante" alt="tio">
                           
                       </div>
                       <div class="contenedor-faltante" alt="pablo">
            ...
            <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="tio">tío</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="pablo">Pablo</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">papá</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="">Luisa</h4>
                </li>
            </ul>
        </div>
