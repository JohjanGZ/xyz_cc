  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="feliz" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="cansado" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                    <li alt="sorprendido" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png"></li>
                    <li alt="triste" class="a" id="obj4"><img src="<?= $dir ?>/img/4.png"></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="feliz" class="b" id="obj6"><h4><img src="<?= $dir ?>/img/8.png"></h4></li>
                  <li alt="cansado" class="b" id="obj7"><h4><img src="<?= $dir ?>/img/6.png"></h4></li>
                  <li alt="sorprendido" class="b" id="obj8"><h4><img src="<?= $dir ?>/img/7.png"></h4></li>
                  <li alt="triste" class="b" id="obj9"><h4><img src="<?= $dir ?>/img/5.png"></h4></li>
                </ul>
            </div>
