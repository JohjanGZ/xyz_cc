  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Primera persona</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Segunda persona</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Tercera persona</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Yo, nosotros, nosotras</span></li>
                  <li alt="dos" class="b" id="obj7"><span>tú, vosotros, vosotras</span></li>
                  <li alt="tres" class="b" id="obj8"><span>él, ella, ellos, ellas</span></li>
                </ul>
            </div>
