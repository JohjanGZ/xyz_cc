  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="abrigo" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="libro" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                    <li alt="brocha" class="a" id="obj3"><img src="<?= $dir ?>/img/3.png"></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="libro" class="b" id="obj6"><span>libro</span></li>
                  <li alt="brocha" class="b" id="obj7"><span>brocha</span></li>
                  <li alt="abrigo" class="b" id="obj8"><span>abrigo</span></li>
                </ul>
            </div>
