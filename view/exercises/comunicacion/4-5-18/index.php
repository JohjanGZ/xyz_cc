  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>El rebaño del cielo.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>La barca de mis sueños.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Perlas de tu boca.</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Bola de fuego.</span></li> 
                </ul>
