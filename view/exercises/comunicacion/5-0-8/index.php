  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>en + amorada</span></li>
                    <li alt="dos" class="a" id="obj2"><span>anti + estrés</span></li>
                    <li alt="tres" class="a" id="obj3"><span>in + capaz</span></li> 
                    <li alt="cuatro" class="a" id="obj4"><span>dis + conforme</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Persona que siente amor.</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Sirve para combatir el estrés.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>No tiene capacidad para algo.</span></li>
                  <li alt="cuatro" class="b" id="obj9"><span>Persona que no está conforme.</span></li>
                </ul>
            </div>
