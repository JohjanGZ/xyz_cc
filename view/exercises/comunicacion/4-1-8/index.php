  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Rasca</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Guarda</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Gira</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Para</span></li> 
                    <li alt="cinco" class="a" id="obj3"><span>Mata</span></li> 
                    <li alt="seis" class="a" id="obj3"><span>Abre</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Cielos</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Bosques</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Sol</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Brisas</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>Moscas</span></li>
                  <li alt="seis" class="b" id="obj8"><span>Latas</span></li>
                </ul>
            </div>
