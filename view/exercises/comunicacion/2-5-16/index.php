  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Muerto el perro se acabó la rabia</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Quien mucho abarca, poco aprieta</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Más sabe el diablo por viejo que por diablo</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Cuando acaba la causa de un problema, se acaba el problema</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Debemos centrarnos en hacer una cosa</span></li>
                  <li alt="tres" class="b" id="obj8"><span>El paso de los años aporta mucho conocimiento.</span></li>
                </ul>
            </div>
