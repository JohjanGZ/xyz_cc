  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="llave" class="a" id="obj1"><span>llave</span></li>
                    <li alt="lluvia" class="a" id="obj2"><span>lluvia</span></li>
                    <li alt="silla" class="a" id="obj3"><span>silla</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="llave" class="b" id="obj6"><img src="<?= $dir ?>/img/1.png"></li>
                  <li alt="lluvia" class="b" id="obj7"><img src="<?= $dir ?>/img/2.png"></li>
                  <li alt="silla" class="b" id="obj8"><img src="<?= $dir ?>/img/3.png"></li>
                </ul>
            </div>
