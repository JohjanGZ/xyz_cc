<?php require('../../../tools/var/variables.php'); ?>
  ...
  <body>
    ...
    <div class="container-two">
        ...
        <!-- <div id='Palabras'></div> -->
        <div class="preguntas">
            <p><span>1.</span>Cantar.</p>
            <p><span>2.</span>Soñar.</p>
            <p><span>3.</span>Leer.</p>
            <p><span>4.</span>Escribir.</p>
            <p><span>5.</span>Gritar.</p>
            <p><span>6.</span>Patinar.</p>
            <p><span>7.</span>Volar.</p>
            <p><span>8.</span>Estirar.</p>
            <p><span>9.</span>Componer.</p>
            <p><span>10.</span>Sonreír.</p>
...
<script type="text/javascript">
    var words = ['cantar', 'soñar', 'leer', 'escribir', 'gritar','patinar','volar','estirar','componer','sonreir'];
