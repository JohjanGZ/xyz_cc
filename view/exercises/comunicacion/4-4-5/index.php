  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Mesa</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Nevera</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Manzana</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Gato</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Silla - Armario</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Horno - Cocina</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Pera - Melón</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Perro - Canario</span></li>
                </ul>
            </div>
