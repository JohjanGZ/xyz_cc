  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>El colegio de Luciana y Natalia</span></li>
                    <li alt="dos" class="a" id="obj2"><span>El helado de Abigail</span></li>
                    <li alt="tres" class="a" id="obj3"><span>La mascota de Elías, Anita y mía</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>La casa de Juan y Sara</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Su colegio</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Su helado</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Nuestra mascota</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Su casa</span></li>
                </ul>
            </div>
