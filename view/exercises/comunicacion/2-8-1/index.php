  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>La rana verde</span></li>
                    <li alt="dos" class="a" id="obj2"><span>El agua del mar</span></li>
                    <li alt="tres" class="a" id="obj3"><span>El plomero</span></li> 
                    <li alt="cuatro" class="a" id="obj2"><span>El domingo pasado</span></li>
                    <li alt="cinco" class="a" id="obj3"><span>Mi hermano mayor</span></li> 
                </ul>

            </div>
            <div class="campo" id="centro">
                <canvas height="100px" width="1050px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>brinca en el estanque</span></li>
                  <li alt="dos" class="b" id="obj7"><span>es salada y verdosa.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>arregló el lavamanos.</span></li>
                  <li alt="cuatro" class="b" id="obj7"><span>fuimos al parque.</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>es muy alto.</span></li>
                </ul>
            </div>
