  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Sus piernas</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Sus labios</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Su aspecto</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="dos" class="b" id="obj6"><span>rosados y ligeramente fruncidos.</span></li>
                  <li alt="uno" class="b" id="obj7"><span>ramas secas.</span></li>
                  <li alt="tres" class="b" id="obj8"><span>roble pequeño y achaparrado.</span></li>
                </ul>
            </div>
