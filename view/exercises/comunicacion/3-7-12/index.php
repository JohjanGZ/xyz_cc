  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Acribillar</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Infatigable</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Fatídico</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Brío</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Abrir muchos agujeros de una cosa</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Que no se fatiga o cansa</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Que presagia acontecimientos nefastos</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>Fuerza y vigor con la que se hace algo</span></li>
                </ul>
            </div>
