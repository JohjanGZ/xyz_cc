  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Punta</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Abre</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Saca</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Corta</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>pie</span></li>
                  <li alt="dos" class="b" id="obj7"><span>latas</span></li>
                  <li alt="tres" class="b" id="obj8"><span>corcho</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>uñas</span></li>
                </ul>
            </div>
