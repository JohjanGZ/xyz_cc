    ...
    <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="t" class="a" id="obj1"><img src="<?= $dir ?>/img/1.png"></li>
                    <li alt="s" class="a" id="obj2"><img src="<?= $dir ?>/img/2.png"></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                    <li alt="t" class="b" id="obj1"><img src="<?= $dir ?>/img/4.png"></li>
                    <li alt="s" class="b" id="obj2"><img src="<?= $dir ?>/img/3.png"></li>
                </ul>
            </div>
