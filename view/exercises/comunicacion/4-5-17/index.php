  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Sexto dedo de la mano.</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Ventanas de un álbum.</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Trenzas de una muñeca.</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>Algodón dulce del cielo.</span></li> 
                </ul>
