  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>autobús</span></li>
                    <li alt="dos" class="a" id="obj2"><span>andar</span></li>
                    <li alt="tres" class="a" id="obj3"><span>danzar</span></li> 
                    <li alt="cuatro" class="a" id="obj2"><span>escuchar</span></li>
                    <li alt="cinco" class="a" id="obj3"><span>ver</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>ómnibus</span></li>
                  <li alt="dos" class="b" id="obj7"><span>caminar</span></li>
                  <li alt="tres" class="b" id="obj8"><span>bailar</span></li>
                  <li alt="cuatro" class="b" id="obj7"><span>oír</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>mirar</span></li>
                </ul>
            </div>
