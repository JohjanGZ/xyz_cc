...
<div class="container">
      <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
              <ul id="listB">    
                <li alt="n" class="a" id="obj7"><img src="<?= $dir ?>/img/7.png"></li>
                <li alt="" class="a" id="obj8"><img src="<?= $dir ?>/img/8.png"></li>
                <li alt="n" class="a" id="obj9"><img src="<?= $dir ?>/img/9.png"></li>
                <li alt="" class="a" id="obj10"><img src="<?= $dir ?>/img/10.png"></li>
                <li alt="" class="a" id="obj11"><img src="<?= $dir ?>/img/11.png"></li>
                <li alt="n" class="a" id="obj12"><img src="<?= $dir ?>/img/12.png"></li>
              </ul>
            </div>
