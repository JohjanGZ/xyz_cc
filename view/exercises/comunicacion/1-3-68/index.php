        ...
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    ...
                    <li alt="molesto" class="a" id="obj5"><img src="<?= $dir ?>/img/5.png"></li>  
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="feliz" class="b" id="obj6"><h4>feliz</h4></li>
                  <li alt="cansado" class="b" id="obj7"><h4>cansado</h4></li>
                  <li alt="sorprendido" class="b" id="obj8"><h4>sorprendido</h4></li>
                  <li alt="triste" class="b" id="obj9"><h4>triste</h4></li>
                  <li alt="molesto" class="b" id="obj9"><h4>molesto</h4></li>  
                </ul>
            </div>
