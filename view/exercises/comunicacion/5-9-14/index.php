...
<body>
    ...
    <div class="contenedor-two">
        <div class="random">
            <div class="oracion">
                <div>
                    <span class="spn">•</span>La constru__ión era majestuosa.
                </div>
            ...
            <div class="oracion">
                <div>
                    <span class="spn">•</span>El ta__ista bajó de su auto y persiguió al ladrón.
                </div>
                <div class="contenedor-check">
            ...
            <div class="oracion">
                <div>
                    <span class="spn">•</span>El paraje era ina__esible pero muy hermoso.
                </div>
                <div class="contenedor-check">
