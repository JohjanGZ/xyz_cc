        ...
        <div class="row">
            ...
            <div class="contenedor-ejercicios">
                ...
                <div class="ejercicio">
                    ...
                    <div class="contenedor-respuesta">
                        <span class="span-after">cere</span>
                ...
                <div class="ejercicio">
                    ...
                    <div class="contenedor-respuesta">
                        ...
                        <span class="span-after">ielo</span>
                    </div>
                </div>
                <div class="ejercicio">
                    <div class="imagen-palabra">
                ...
                <div class="ejercicio">
                    ...
                    <div class="contenedor-respuesta">
                        ...
                        <span class="span-after">apato</span>
                    </div>
                </div>
                <div class="ejercicio">
                    <div class="imagen-palabra">
                    ...
                    <div class="contenedor-respuesta">
                        ...
                        <span class="span-after">orro</span>
                    </div>
                </div>
            </div>
            <ul class="contenedor-silabas">
                <li class="silabas">
                    <h4 class="pieza" alt="z">z</h4>
                </li>
                <li class="silabas">
                    <h4 class="pieza" alt="z">z</h4>
                </li>
