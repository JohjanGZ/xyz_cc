            ...
            <div class="campo" id="palabras">
                <ul id="listA">
                    <li id="obj1" >
                        ...
                        <div class="respuesta">
                            <div class="box a" alt="">ra</div><span>/</span>
                            <div class="box a" alt="n">rro</div>
                        </div>
                    </li>
                    <li id="obj2" >
                        <div class="box-img">
                        ...
                        <div class="respuesta">
                            <div class="box a" alt="n">ra</div><span>/</span>
                            <div class="box a" alt="">roo</div>
                        </div>
                    </li>
                    <li id="obj3" >
                        <div class="box-img">
