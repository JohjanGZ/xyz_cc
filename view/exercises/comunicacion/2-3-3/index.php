  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Frío</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Bueno</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Bonito</span></li> 
                    <li alt="cuatro" class="a" id="obj2"><span>Abrir</span></li>
                    <li alt="cinco" class="a" id="obj3"><span>Vacío</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Caliente</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Malo</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Feo</span></li>
                  <li alt="cuatro" class="b" id="obj7"><span>Cerrar</span></li>
                  <li alt="cinco" class="b" id="obj8"><span>Lleno</span></li>
                </ul>
            </div>
