  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Un lindo pez</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Dos guardaespaldas</span></li>
                    <li alt="tres" class="a" id="obj3"><span>Mi linda muñeca</span></li> 
                    <li alt="cuatro" class="a" id="obj3"><span>La mamá de sarita</span></li> 
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>nada contra la corriente</span></li>
                  <li alt="dos" class="b" id="obj7"><span>acompañan al presidente</span></li>
                  <li alt="tres" class="b" id="obj8"><span>tiene un hermoso vestido azul</span></li>
                  <li alt="cuatro" class="b" id="obj8"><span>le compró un par de zapatos</span></li>
                </ul>
            </div>
