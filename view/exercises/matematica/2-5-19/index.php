...
<?=$titulo?>
<?php 
    $barras = array('2 x 5 = 10','4 x 5 = 20','5 x 6 = 30','3 x 4 = 12','5 x 5 = 25'); 
?>
<body>
    <div class="container-two">
        ...
        <div class="columnaDos grid-container">
            ...
            <div class="grid-item">
            <select class="slc seleccion" alt="5 x 5 = 25">
            ...
            <div class="grid-item">
                <select class="slc seleccion" alt="4 x 5 = 20">
                    <option value="" disabled selected></option>
                    <?php
                        for ($i=0; $i < count($barras); $i++) { 
                            echo "<option value='$barras[$i]'>$barras[$i]</option>";
            ...
            <div class="grid-item">
            <select class="slc seleccion" alt="2 x 5 = 10">
                    <option value="" disabled selected></option>
                    <?php
                        for ($i=0; $i < count($barras); $i++) { 
                            echo "<option value='$barras[$i]'>$barras[$i]</option>";
