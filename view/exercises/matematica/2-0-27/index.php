...
<div class="container">
      <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
              ...
              <ul id="listA">
                <li alt="ningun"  class="a" id="obj1"><img src="img/1-20/conjuntoUno.gif"></li>
                <li alt="algunos" class="a" id="obj2"><img src="img/1-20/conjuntoDos.gif"></li>
                <li alt="todos" class="a" id="obj3"><img src="img/1-20/conjuntoTres.gif"></li>
              </ul>
            ...
            <div class="campo" id="imgDerecha">
              <ul id="listB">
                <li alt="algunos" class="b" id="obj2"><img src="img/1-20/1.png"></li>
                <li alt="ningun" class="b" id="obj3"><img src="img/1-20/2.png"></li>
                <li alt="todos" class="b" id="obj4"><img src="img/1-20/3.png"></li>
              </ul>
            </div>
          ...
          <div class="row fila2">
              ...
              <div id="modal1" class="modal">
                  ...
                  <center>
                  <img class="materialboxed"  width="80%" src="img/1-27/respuesta.png">
                  </center>
                  </div>
                    ...
                    if(obj1==obj2){
                      ...
                      console.log(r);
                        ...
                        function result_tipo_2_0_27(){           
                          ...
                          if(r==3){                  
                              localStorage.setItem("Nota2-0-27","2");
                              localStorage.setItem("Time2-0-27", tiempo);
                              correcto(); 
                          }
                          else{
                              incorrecto();
                              localStorage.setItem("Nota2-0-27","0");
                              localStorage.setItem("Time2-0-27", tiempo);
                          }    
                        } 
</script>
