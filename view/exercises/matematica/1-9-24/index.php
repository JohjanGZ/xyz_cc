...
<?=$titulo?>
<?php $nom = array('durazno', 'piña','galletas', 'chocolate', 'fresa','manzana') ?>

<body>
    <div class="container-two">
        <div class="grid-container">
            <div class="grid-template">
                <div class="grid-tabla"><img src="<?=$dir?>/img/1.png" class="img">piña</div>
            ...
            <div class="grid-template">
                <div class="grid-tabla"><img src="<?=$dir?>/img/4.png" class="img">manzana</div>
                <div class="grid-tabla"><img src="<?=$dir?>/img/f1.png" class="f1"></div>
                <div class="grid-tabla">
                    <div class="grid">
                        <div class="grid-pre">
