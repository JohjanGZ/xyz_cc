    ...
    <div class="container-two">
        <div class="grid">
            <div class="secuencia">
                ...
                <div class="contenedor p1" alt="39"></div>
            </div>
            <div class="option">
                <div class="pieza" alt="">20</div>
                <div class="pieza" alt="39">39</div>
                <div class="pieza" alt="">38</div>
                <div class="pieza" alt="">40</div>
                <div class="pieza" alt="">42</div>
                <div class="pieza" alt="">14</div>
                <div class="pieza" alt="">49</div>
                <div class="pieza" alt="">18</div>
                <div class="pieza" alt="">28</div>
