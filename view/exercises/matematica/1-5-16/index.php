...
<body>
    ...
    <div class="container-two">
        <div class="grid-options">
            ...
            <!-- 701 -->
            <div class="grid-option">
                <img src="<?=$dir?>/img/7.png" class="img materialboxed">
            ...
            <!-- 457 -->
            <div class="grid-option">
                <img src="<?=$dir?>/img/8.png" class="img materialboxed">
            ...
            <!-- 198 -->
            <div class="grid-option">
                <img src="<?=$dir?>/img/9.png" class="img materialboxed">
            ...
            <!-- 355 -->
            <div class="grid-option">
                <img src="<?=$dir?>/img/10.png" class="img materialboxed">
