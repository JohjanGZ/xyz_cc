    ...
    <div class="container-two">
        <div class="vertical">
            ...
            <div class="grid-canva">
                <canvas id="micanvas" width="95" height="377"></canvas>
            </div>
            <div class="grid-container">
                <div class="grid-item-b" alt="1">0,92</div>
                <div class="grid-item-b" alt="2">0,56</div>
                <div class="grid-item-b" alt="3">0,57</div>
            </div>
        </div>
    </div>
