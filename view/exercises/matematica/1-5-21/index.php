...
<body>
    ...
    <div class="container-two">
        <center>
            <p class="p"><span class='ftitulo'>a.</span> En un acuario hay 154 peces payaso y 123 peces araña. Si nacen 121 peces payaso, ¿cuántos peces payaso hay ahora?</p>
        </center>
        <div class="grid-cabecera">
            ...
            <div class="grid-item clr co">Había<span class="fle">→</span></div>
            ...
            <div class="grid-item clr cr">Nacen<span class="fle">→</span></div>
            <div class="grid-item w bb">1</div>
            <div class="grid-item w bb">5</div>
