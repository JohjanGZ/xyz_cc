...
<?php
    $numeros = array('200','250','400','500','1150','1500');
?>
<?=$titulo?>
<div class="container-two">
    ...
    <div class="table">
        <h6 class="preg">¿Cuántas flores tiene en total en su jardín?</h6>
        <div class="minitable">
            <div class="cuadro">
                <div>
