    ...
    // Select
    var r = 0;
    $("#slc1").change(function() { if ($(this).val() == 11) { r++; } });
    $("#slc2").change(function() { if ($(this).val() == 14) { r++; } });
    $("#slc3").change(function() { if ($(this).val() == 1) { r++; } });
    $("#slc4").change(function() { if ($(this).val() == 1) { r++; } });
    $("#slc5").change(function() { if ($(this).val() == 1) { r++; } });
    $("#slc6").change(function() { if ($(this).val() == 4) { r++; } });
    $("#slc7").change(function() { if ($(this).val() == 2) { r++; } });
    $("#slc8").change(function() { if ($(this).val() == 5) { r++; } });
