    ...
    // Select
    var r = 0;
    // $("#slc1").change(function() { if ($(this).val() == 5) { r++; } });
    // $("#slc2").change(function() { if ($(this).val() == 7) { r++; } });
    // $("#slc3").change(function() { if ($(this).val() == 12) { r++; } });
    $("#slc4").change(function() { if ($(this).val() == 11) { r++; } });
    $("#slc5").change(function() { if ($(this).val() == 5) { r++; } });
    $("#slc6").change(function() { if ($(this).val() == 16) { r++; } });
