    ...
    <div class="row svg">
        ...
        <div class="campo" id="imgIzquierda">
            ...
            <ul id="listA">
                ...
                <li alt="7" class="a" id="obj2"><img src="<?= $dir ?>/img/7.png"></li>
                <li alt="6" class="a" id="obj3"><img src="<?= $dir ?>/img/6.png"></li>
        ...
        <div class="campo" id="imgDerecha">
            <ul id="listB">
                <li alt="7" class="b" id="obj2"><span>7</spna>
                </li>
                <li alt="1" class="b" id="obj3"><span>1</spna>
                </li>
                <li alt="6" class="b" id="obj4"><span>6</spna>
                </li>
                <li alt="4" class="b" id="obj4"><span>4</spna>
                </li>
                <li alt="9" class="b" id="obj4"><span>9</spna>
                </li>
            </ul>
        </div>
