                ...
                <div class="contenedor">
                    ...
                    <p>
                        ...
                        <span class="select">
                            <select class="browser-default seleccion" alt="n">
                                <option value="" disabled selected></option>
                                <option value="X">7,4 cm²</option>
                                <option value="x">7,2 cm²</option>
                                <option value="x">7,1 cm²</option>
                                <option value="n">7,5 cm²</option>
                            </select>
                        </span>
                    </p>
                ...
                <div class="contenedor">
                    ...
                    <p>
                        ...
                        <span class="select">
                            <select class="browser-default seleccion" alt="n">
                                <option value="" disabled selected></option>
                                <option value="x">33 cm²</option>
                                <option value="x">37 cm²</option>
                                <option value="X">34 cm²</option>
                                <option value="n">36 cm²</option>
                            </select>
                        </span> 
                    </p>
                </div>
