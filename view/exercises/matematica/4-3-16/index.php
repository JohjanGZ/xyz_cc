  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    <li alt="uno" class="a" id="obj1"><span>Lapicero</span></li>
                    <li alt="dos" class="a" id="obj2"><span>Largo unahoja A-4</span></li>
                    <li alt="tres" class="a" id="obj2"><span>Altura de tu mesa</span></li>
                    <li alt="cuatro" class="a" id="obj2"><span>Altura de la sala <br> de tu casa</span></li>
                </ul>
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>15 cm</span></li>
                  <li alt="dos" class="b" id="obj7"><span>27 cm</span></li>
                  <li alt="tres" class="b" id="obj8"><span>75 cm</span></li>
                  <li alt="cuatro" class="b" id="obj9"><span>2 m y 43 cm </span></li>
                </ul>
            </div>
