...
<body>
    ...
    <div class="container-two">
        <h5>(2UM; 5C; 6D; 7U) + (2UM; 4C; 2D; 1U)</h5>
        <div class="item">
            <div class="grid-head">
            ...
            <div class="grid-container">
                <div class="grid-caja">
                    ...
                    <div class="grid-item w">
                        <select class="slc seleccion" id="slc2" alt="6">
                            <option value="" disabled selected></option>
                            <?php foreach($result as $n) : ?>
                            <option value="<?= $n ?>"><?= $n ?></option>
                            <?php endforeach; ?>
                ...
                <div class="grid-caja">
                    ...
                    <div class="grid-item w">
                        <select class="slc seleccion" id="slc2" alt="9">
                            <option value="" disabled selected></option>
                            <?php foreach($result as $n) : ?>
                            <option value="<?= $n ?>"><?= $n ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="grid-item w">
                        <select class="slc seleccion" id="slc2" alt="8">
                            <option value="" disabled selected></option>
                            <?php foreach($result as $n) : ?>
                            <option value="<?= $n ?>"><?= $n ?></option>
                            <?php endforeach; ?>
