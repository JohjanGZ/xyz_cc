        ...
        <div class="col l10">
            <div class="grid-preguntas">
                <div class="item">
                    ...
                    <div class="contenedor p1" alt="0,7"></div>
                    <div class="contenedor p2" alt="2,6"></div>
                    <div class="contenedor p3" alt="5,1"></div>
                </div>
            </div>
        </div>
    </div>
