...
<?php 
    ...
    $numeros = array('1','6', '8','5','4', '2', '929','9', '0', '890');

?>
<div class="container-two">
    <div class="filaUno">
        <div class="columna primero">
            <h5>   d. Jorge comprará dos ollas arroceras y dos planchas. ¿Cuánto gastará?</h5>
...
function result_tipo_2_3_28() {
    ...
    if (r == 16) {
        console.log(r);
        localStorage.setItem("Nota2-3-28", "2");
        localStorage.setItem("Time2-3-28", tiempo);
        correcto();

    } else {
        console.log(r);
        incorrecto();
        localStorage.setItem("Nota2-3-28", "0");
        localStorage.setItem("Time2-3-28", tiempo);
