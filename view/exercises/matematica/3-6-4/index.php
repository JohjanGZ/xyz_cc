...
<?=$titulo?>
<?php $num = array('0,14','0,7','9','0,09','100','0,9','0,5','0,07','0,1','10','9','14','7','1');
?>
            ...
            <div class="col l8">
                ...
                <div class="grid-container">
                    ...
                    ?>
                        ...
                        <div class="grid-item">
                            <select class="seleccion" alt="0,14">
                                <option value="" disabled selected></option>
                                <?php
                        for ($i=0; $i < count($num); $i++) { 
                            echo "<option value='$num[$i]'>$num[$i]</option>";
                    ...
                    ?>
                        ...
                        <div class="grid-item">
                            <select class="seleccion" alt="0,07">
                                <option value="" disabled selected></option>
                                <?php
                        for ($i=0; $i < count($num); $i++) { 
                            echo "<option value='$num[$i]'>$num[$i]</option>";
                    ...
                    ?>
                        ...
                        <div class="grid-item">
                            <select class="seleccion" alt="0,09">
                                <option value="" disabled selected></option>
                                <?php
                        for ($i=0; $i < count($num); $i++) { 
                            echo "<option value='$num[$i]'>$num[$i]</option>";
