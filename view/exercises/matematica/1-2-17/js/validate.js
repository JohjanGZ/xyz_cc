    ...
    $("#slc2").change(function() { if ($(this).val() == 11) { r++; } });
    $("#slc3").change(function() { if ($(this).val() == 13) { r++; } });
    $("#slc4").change(function() { if ($(this).val() == 15) { r++; } });
    $("#slc5").change(function() { if ($(this).val() == 17) { r++; } });
    $("#slc6").change(function() { if ($(this).val() == 19) { r++; } });
