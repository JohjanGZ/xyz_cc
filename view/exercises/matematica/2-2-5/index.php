...
<div class="container-two">
    ...
    <div class="row boxCheck aleatorio" id="boxCheck">
        <div class="cajas cajaOpciones col s12 aleatorio">
            <p class="obj" data-value="372">Ochocientos dieciséis</p>
            <p class="obj" data-value="426">Seiscientos cincuenta y tres</p>
            <p class="obj" data-value="515">Setecientos sesenta y siete</p>
            <p class="obj" data-value="210">Novecientos treinta y cinco</p>
            <p class="obj" data-value="618">Ciento ochenta y nueve</p>
            <p class="obj" data-value="589">Setecientos dieciocho</p>
        </div>
    </div>
</div>
