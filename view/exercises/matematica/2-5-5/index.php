      ...
      <div class="row svg">
            ...
            <div class="campo" id="imgIzquierda">
              ...
              <ul id="listA">
                ...
                <li alt="4" class="a" id="obj4"><img src="<?= $dir ?>/img/4.png" alt=""></li>
              </ul>
            ...
            <div class="campo" id="imgDerecha">
              <ul id="listB">
                ...
                <li alt="1" class="b" id="obj2"><img src="<?= $dir ?>/img/5.png" alt=""></li>
                <li alt="4" class="b" id="obj3"><img src="<?= $dir ?>/img/6.png" alt=""></li>
                <li alt="2" class="b" id="obj4"><img src="<?= $dir ?>/img/7.png" alt=""></li>
                <li alt="3" class="b" id="obj4"><img src="<?= $dir ?>/img/8.png" alt=""></li>
              </ul>
            </div>
