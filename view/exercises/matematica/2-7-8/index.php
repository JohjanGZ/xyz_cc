        ...
        <div class="caja">
            <div class="tabla">
                <div class="grid-container">
                    <div class="principalNumber">1983</div>
                    ...
                    <div class="grid-item" style="position:relative;">
                        <select class="slc" id="slc2" alt="8">
                            <option value="" disabled selected></option>
                            <?php 
                                foreach($numbers as $n) : ?>
                                    <option value="<?= $n ?>"><?= $n ?></option>
                ...
                <div class="grid-container">
                    <div class="principalNumber">6410</div>
                    <div class="grid-item cabe"><span class="o">UM</span></div>
                    <div class="grid-item cabe"><span class="b">C</span></div>
                    <div class="grid-item cabe"><span class="r">D</span></div>
                    <div class="grid-item cabe"><span class="b">U</span></div>
                ...
                <div class="grid-container">
                    <div class="principalNumber">3769</div>
                    <div class="grid-item cabe"><span class="o">UM</span></div>
                    <div class="grid-item cabe"><span class="b">C</span></div>
                    <div class="grid-item cabe"><span class="r">D</span></div>
                    <div class="grid-item cabe"><span class="b">U</span></div>
                    ...
                    <div class="grid-item">
                        <select class="slc" id="slc2" alt="7">
                            <option value="" disabled selected></option>
                            <?php 
                                foreach($numbers as $n) : ?>
                                    <option value="<?= $n ?>"><?= $n ?></option>
                ...
                <div class="grid-container">
                    <div class="principalNumber">8484</div>
                    <div class="grid-item cabe"><span class="o">UM</span></div>
                    <div class="grid-item cabe"><span class="b">C</span></div>
                    <div class="grid-item cabe"><span class="r">D</span></div>
                    <div class="grid-item cabe"><span class="b">U</span></div>
                ...
                <div class="grid-container">
                    <div class="principalNumber">5598</div>
                    <div class="grid-item cabe"><span class="o">UM</span></div>
                    <div class="grid-item cabe"><span class="b">C</span></div>
                    <div class="grid-item cabe"><span class="r">D</span></div>
                    <div class="grid-item cabe"><span class="b">U</span></div>
                    <div class="grid-item" style="position:relative;">
                        <select class="slc" id="slc2" alt="5">
                            <option value="" disabled selected></option>
                            <?php 
                                foreach($numbers as $n) : ?>
                                    <option value="<?= $n ?>"><?= $n ?></option>
                ...
                <div class="grid-container">
                    <div class="principalNumber">4632</div>
                    <div class="grid-item cabe"><span class="o">UM</span></div>
                    <div class="grid-item cabe"><span class="b">C</span></div>
                    <div class="grid-item cabe"><span class="r">D</span></div>
                    <div class="grid-item cabe"><span class="b">U</span></div>
