...
<div class="container-two">
    <div class="filaUno">
        ...
        <div class="pregunta">
            <h6>Respuesta: Anita y David tienen <span class="rpta droppable" data-value="449"></span> postales.</h6>
        </div>
        <div class="options">
...
function result_tipo_2_3_22() {
    ...
    if (rpta == 10) {
        console.log(rpta);
        localStorage.setItem("Nota2-3-22", "2");
        localStorage.setItem("Time2-3-22", tiempo);
        correcto();

    } else {
        console.log(rpta);
        incorrecto();
        localStorage.setItem("Nota2-3-22", "0");
        localStorage.setItem("Time2-3-22", tiempo);
