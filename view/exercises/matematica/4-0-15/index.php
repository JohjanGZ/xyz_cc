  ...
  <div class="container">
        <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                  <li alt="uno" class="b" id="obj6"><span>Recta L</span></li>
                  <li alt="dos" class="b" id="obj7"><span>Segmento MN</span></li>
                  <li alt="tres" class="b" id="obj8"><span>Recta T</span></li>
                  <li alt="cuatro" class="b" id="obj9"><span>Plano Q</span></li>
                </ul>
            </div>
