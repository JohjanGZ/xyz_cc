            ...
            <div class="campo" id="imgIzquierda">
                ...
                <ul id="listA">
                    ...
                    <li alt="4" class="a" id="obj1">
                        <center><img src="<?= $dir ?>/img/4.png"></center>
                    </li>
                </ul>

            </div>
            <div class="campo" id="centro">
                <canvas height="105px" width="680px" id="micanvas"></canvas>
            </div>
            <div class="campo" id="imgDerecha">
                <ul id="listB">
                    ...
                    <li alt="2" class="b" id="obj7">
                        <center><img src="<?= $dir ?>/img/6.png"></center>
                    </li>
                    <li alt="3" class="b" id="obj8">
                        <center><img src="<?= $dir ?>/img/7.png"></center>
                    </li>
