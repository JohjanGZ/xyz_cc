...
<div class="container">
      <div class="row svg">
            ...
            <div class="campo" id="imgDerecha">
              <ul id="listB" class="aleatorio">
                <li alt="1" class="b" id="obj4"><img src="<?= $dir ?>/img/5.png" alt=""></li>
                <li alt="2" class="b" id="obj4"><img src="<?= $dir ?>/img/6.png" alt=""></li>
                <li alt="4" class="b" id="obj4"><img src="<?= $dir ?>/img/7.png" alt=""></li>
